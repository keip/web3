      ...
      if (tokenAddress !== undefined) {
        setTransactions(
          props.transactions.filter(
            (t) =>
              t.transactionSubtype !== "zero-transfer" &&
  ...
  return detail !== null ? (
    <Box px={3} py={6}>
      <Grid container spacing={3}>
        <Grid item md={12}>
          <Typography variant="h3">{detail.asset}</Typography>
        </Grid>
        <Grid item md={12}>
          <Typography variant="h4">{detail.balance}</Typography>
        </Grid>
                ...
                <CardContent>
                  ...
                  >
                    <Grid item>
                      <Typography
                        color={
                          transaction.transactionSubtype === "incoming"
                            ? "green"
                            : "red"
                        }
                      >
